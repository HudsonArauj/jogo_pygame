...
def carrega_recurso():
    ...
    recursos['letra_I_imagem'] = pygame.transform.scale(recursos['letra_I_imagem'], (dimensao_letras, dimensao_letras))
    recursos['letra_D_imagem'] = pygame.transform.scale(recursos['letra_D_imagem'], (dimensao_letras, dimensao_letras))
